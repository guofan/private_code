        ...
        function initdata(){
            ...
            $("#printbt").click(function(){
                var url = "/print?house_info="+cur_house;
                window.open(url);
            });
        ...
        function setResultList(type){
			...
			new_keylist.sort(function(a,b){return parseInt(a)>parseInt(b)?1:-1;});
        ...
        function chooseHouseType(housetype){
            ...
            box.innerHTML="准备选取"+housetype+"房型";
            console.log(type);
        }
        function doit(){
